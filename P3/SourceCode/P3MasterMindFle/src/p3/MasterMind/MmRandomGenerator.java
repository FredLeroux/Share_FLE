...
public class MmRandomGenerator {
	...
	/**
	 * nbDigits = number of usable digits for secret code generation
	 * nbNumber = number of digits composing secret code
	 * nbDgtSrcTableI =  usable digits source table index number 
	 * rdChar = random number selected among digits source table
	 * pcSecretCode = computer generated secret code
	 * */
...
/** nbDigitsSources = table of usable digits for secret code generation size equals nbDigits*/
...
Random randomNb = new Random();
	...
	public MmRandomGenerator() {
		...
		/** random integer generation between 0 and usable digits table size i.e if A = 5 random number generated will be into the rang 0-5)*/
